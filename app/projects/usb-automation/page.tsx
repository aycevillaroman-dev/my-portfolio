// app/projects/usb-provisioning/page.tsx
"use client";
...
const project = {
  ...
  subtitle: "Employee Onboarding Automation",
  publishedAt: "2026-04-17",
  summary:
    "A C++ and Windows API-based executable that automates system setup, user account creation, and application installation for new employees via a bootable USB.",
  images: ["/images/projects/USBProvisioning/usb1.jpg"],
  team: [
    {
  ...
  overview: `Bootable USB Employee Provisioning System is a low-level automation tool designed to streamline the device setup process for new employees and internal users.

Built using C++ and Windows API, the system runs as a standalone executable from a bootable USB drive, enabling IT teams to quickly prepare machines without manual configuration.

It automates critical onboarding steps such as Windows user account creation, role assignment (admin or standard user), password setup, and installation of required applications, all in one unified workflow.`,
  features: [
    "Bootable USB execution without pre-installed software",
    "Automated Windows user account creation with predefined roles",
    "Admin privilege assignment and password configuration",
    "Essential application deployment for onboarding",
    "All-in-one setup consolidating multiple IT steps",
  ],
  technologies: ["C++", "Windows API", "Batch Scripting", "Executable (.exe)", "System Administration"],
  outcome: `Significantly reduces time and effort for device setup during onboarding, providing a fast, standardized, and scalable solution for IT teams. Ensures every new employee receives a properly configured system with necessary accounts and applications from the start.`,
};
...
// ─── Main Page ─────────────────────────────────────────────────────────────────
export default function USBProvisioningPage() {
      ...
      <main className="flex-1">
        ...
        <section className="relative min-h-screen flex flex-col justify-center px-8 sm:px-16 lg:px-24 overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-5xl mx-auto">
            ...
            <motion.h1
              ...
              className="text-[clamp(3rem,10vw,8rem)] font-black tracking-tighter leading-[0.88] mb-6 select-none"
            >
              <span className={darkMode ? "text-white" : "text-black"}>USB</span>
              <span className={darkMode ? "text-white/20" : "text-black/40"}> Provisioning</span>
            </motion.h1>
        ...
        >
          <div className="max-w-6xl mx-auto">
            ...
            <Link href="/projects/accountability-form">
              <motion.div
                whileHover={{ x: 4 }}
