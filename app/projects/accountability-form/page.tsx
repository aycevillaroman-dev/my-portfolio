// app/projects/accountability-system/page.tsx
"use client";
...
const project = {
  ...
  summary:
    "A Streamlit-based system that automates SharePoint data retrieval and generates Word documents for client onboarding accountability tracking.",
  images: ["/images/projects/AccountabilitySystem/acc1.jpg"],
  team: [
    {
  ...
  overview: `Accountability System is a web-based automation tool designed to streamline the client onboarding process by generating structured accountability documents.

Built using Python and Streamlit, the system connects to SharePoint to retrieve client and inventory data, processes it, and automatically generates a Word document output for printing and documentation.

This eliminates manual encoding, reduces errors, and ensures a consistent format for tracking accountability of items assigned to new clients.`,
  features: [
    "SharePoint integration for real-time client and inventory data",
    "Automated Word document generation ready for printing",
    "Data cleaning and structuring for accurate reporting",
    "User-friendly Streamlit interface for easy operation",
    "Minimizes manual work and reduces human error",
  ],
  technologies: ["Python", "Streamlit", "OpenPyXL", "SharePoint API", "python-docx"],
  outcome: `Significantly improves the onboarding workflow by automating the creation of accountability documents. Provides a reliable, fast, and standardized solution for tracking assigned items, helping teams ensure proper documentation and accountability for every new client onboarding process.`,
};
...
// ─── Main Page ─────────────────────────────────────────────────────────────────
export default function AccountabilitySystemPage() {
      ...
      <main className="flex-1">
        ...
        <section className="relative min-h-screen flex flex-col justify-center px-8 sm:px-16 lg:px-24 overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-5xl mx-auto">
            ...
            >
              <span className={darkMode ? "text-white" : "text-black"}>Accountability</span>
              <span className={darkMode ? "text-white/20" : "text-black/40"}> System</span>
            </motion.h1>
...
>
  <div className="max-w-6xl mx-auto">
    ...
    <Link href="/projects/hmo-automation">
      <motion.div
        whileHover={{ x: 4 }}
      ...
      >
        <div>
          ...
          <p className={`font-mono text-xs mt-1 ${muted}`}>
            Python · Streamlit · Billing Automation
          </p>
        </div>
        <ArrowRight
          size={20}
