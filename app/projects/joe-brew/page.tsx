// app/projects/joe-brew/page.tsx
"use client";
...
const project = {
  title: "JoeBrew",
  subtitle: "Coffee Shop Platform",
  publishedAt: "2025-09-11",
  summary:
    "A web application showcasing JoeBrew's offerings including coffee, milk tea, frappes, and takoyaki, with online ordering and interactive features.",
  images: ["/joebrew.png"],
  team: [
    {
  ...
  overview: `JoeBrew is a full-stack coffee shop web platform built on a PHP and XAMPP backend, with a vanilla JavaScript and CSS frontend. The system handles the complete customer journey — from browsing the menu to placing and managing orders — without relying on any external frameworks.

The backend is powered by PHP running on a local Apache server via XAMPP, with MySQL as the database layer. Product listings, categories, pricing, and order records are all stored in MySQL and queried dynamically through PHP scripts. Sessions are used to maintain cart state across pages, and form submissions are handled server-side with input sanitization to prevent SQL injection.

On the frontend, vanilla JavaScript drives all interactive behavior: dynamic cart updates, quantity controls, real-time price calculations, and menu filtering by category. CSS handles the full visual design — responsive layouts built with Flexbox, custom animations, and a consistent component system styled by hand without utility frameworks.

The ordering flow starts on the menu page where customers browse products organized by category. Adding items updates the cart in real time via JavaScript DOM manipulation and PHP session writes. The checkout page summarizes the order, collects customer details, and submits to a PHP endpoint that writes the order to MySQL and clears the session. An admin panel built in PHP provides the shop owner with a live view of incoming orders, the ability to update product details, and basic inventory controls.`,
  features: [
  ...
  technologies: ["PHP", "XAMPP", "JavaScript", "CSS", "MySQL", "HTML5"],
  outcome: `Successfully launched a functional online ordering platform that streamlines the customer experience and supports business operations.`,
};
...
// ─── Main Page ─────────────────────────────────────────────────────────────────
export default function JoeBrewPage() {
  ...
  // ─── Theme tokens (identical to main portfolio) ─────────────────────────────
      ...
      <main className="flex-1">
        ...
        <section className="relative min-h-screen flex flex-col justify-center px-8 sm:px-16 lg:px-24 overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-5xl mx-auto">
            ...
            >
              <span className={darkMode ? "text-white" : "text-black"}>Joe</span>
              <span className={darkMode ? "text-white/20" : "text-black/40"}>Brew</span>
            </motion.h1>
            ...
            <div className="grid md:grid-cols-[1fr_340px] gap-16 items-start">
              ...
              >
                ...
                <p className={`text-sm leading-relaxed ${mutedText}`}>
                  Streamlines the customer experience from menu browsing to
                  checkout, supporting real{" "}
        ...
        >
          <div className="max-w-6xl mx-auto">
            ...
            <Link href="/projects/premiere-shots">
              <motion.div
                whileHover={{ x: 4 }}
